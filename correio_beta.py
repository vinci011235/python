...
try:
	site = "http://websro.correios.com.br/sro_bin/txect01%24.QueryList?P_LINGUA=001&P_TIPO=001&P_COD_UNI="
	codigo = raw_input('Codigo de rastreamento: ')

	#Aborta a execução se for diferente de 13
	if len(codigo) != 13:
	   print '\nPadrão nao corresponde\n'
	   exit(1)

	#Formata a URL da cidade, garantindo que as siglas do estado serão maiúsculas	
	url = site + codigo.upper()
